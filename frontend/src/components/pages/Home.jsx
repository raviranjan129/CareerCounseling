...
const Home = () => {
 ...
 <div className="flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 lg:px-8 py-8 md:py-12 lg:py-20">
   <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 leading-tight mb-4 md:mb-6">
            TO ACHIEVE OUR <br/><span className="text-blue-500">GOALS</span><br/> WE MUST KNOW OUR<br/> <span className="text-blue-500">STRENGTHS!</span>
            </h1>
 <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-6 md:mb-8">
           Discover your potential and shape your future with expert career guidance
         </p>
            
     </div>
  <div className="w-full md:w-1/2 flex justify-center mt-8 md:mt-0">
        <img
        src="../../../Screenshot 2025-04-01 115553.png"
        alt="Career Guidance"
     ...
     <div className="relative w-full bg-gradient-to-r from-blue-900 to-blue-800">
...
<div className="container mx-auto px-4">
     ...
     We are India's largest career counselling company that works with millions of students every year. We are a team of passionate teammates who are working to make career guidance a mainstream phenomenon. We have the perfect blend of education + technology of excellence + experience and an unmatched passion  to make sure that every student progresses on the right path.
     </p>
     <p className="text-base sm:text-lg md:text-xl text-gray-600 leading-relaxed mt-4 md:mt-6">
           We are focused on providing career counselling and guidance services to students of classes 9th, 10th, 11th, 12th apart from providing 360 degree guidance to undergraduates and college students. We also help  Private Schools, Non-Profits, Governments and CSRs in improving education by imparting the following services.
            </p>
          </div>
     </div>
     </div>
